  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        <span className="bg-gradient-to-r from-emerald-400 to-lime-300 bg-clip-text text-transparent uppercase tracking-[0.3em] text-xs font-black mb-6 animate-fade-rise font-orange pb-1">
        ...
        >
          ...
          <span 
            className="inline-block pl-8 pr-8 pb-3 pt-1 text-transparent bg-clip-text bg-gradient-to-r from-[#ffe49e] via-[#d4af37] to-[#ffffff] font-rustic drop-shadow-[0_2px_12px_rgba(212,175,55,0.2)]"
          ...
          <span 
            className="text-white text-base sm:text-2xl md:text-3xl lg:text-4xl uppercase tracking-[0.55em] font-medium font-luxury drop-shadow-[0_2px_15px_rgba(255,255,255,0.3)] transition-all duration-500 hover:text-emerald-400 pl-[0.55em]"
        ...
        >
          ...
          <span className="text-lime-300 font-extrabold underline decoration-lime-500/30 underline-offset-4">thrilling water slides</span>,{' '}
          <span className="text-lime-300 font-extrabold underline decoration-lime-500/30 underline-offset-4">family swimming pools</span>,{' '}
          <span className="text-lime-300 font-extrabold underline decoration-lime-500/30 underline-offset-4">exciting rain dance zones</span>, and{' '}
          <span className="text-lime-300 font-extrabold underline decoration-lime-500/30 underline-offset-4">unforgettable moments</span> with friends and loved ones.
        </p>
        ...
        <div className="animate-fade-rise-delay-2 mt-12 flex flex-col items-center gap-4">
          <button
            onClick={onBookClick}
            id="hero-cta-button"
            className="liquid-glass rounded-full px-14 py-5 text-sm text-emerald-300 hover:text-emerald-200 border-2 border-emerald-400/30 hover:border-emerald-400/60 hover:bg-white/10 font-extrabold uppercase tracking-widest hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer shadow-xl flex items-center gap-3 font-orange bg-white/5"
          >
            <CalendarRange className="w-5 h-5 text-emerald-400 animate-pulse" />
            Book Your Day Pass
          </button>
          ...
          <span className="text-xs text-sky-200 font-semibold mt-1 pb-1 font-orange tracking-wider uppercase drop-shadow-[0_1px_3px_rgba(0,0,0,0.5)]">
            Entry Pass starting at just <span className="text-lime-300 font-black">₹350</span>
          </span>
        </div>
      </div>
